...
\def\FontSm{% 14 pt bold
  \usefont{T1}{phv}{m}{n}\fontsize{9pt}{9pt}\selectfont}
\def\FontSn{% 12 pt normal
  \usefont{T1}{phv}{m}{n}\fontsize{11pt}{11pt}\selectfont}

% Define page margins and line spacing.
% set the page margins (2.5cm minimum in every side, as per IST rules)
\usepackage{geometry}
\geometry{verbose,tmargin=1.5cm,bmargin=1.5cm,lmargin=1.5cm,rmargin=1.5cm,paperwidth=12cm,paperheight=12cm}
